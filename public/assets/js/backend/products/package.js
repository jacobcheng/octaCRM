define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'products/package/index' + location.search,
                    add_url: 'products/package/add',
                    edit_url: 'products/package/edit',
                    del_url: 'products/package/del',
                    multi_url: 'products/package/multi',
                    table: 'package',
                }
            });
        ...
        recyclebin: function () {
            ...
            // 初始化表格
            table.bootstrapTable({
                url: 'products/package/recyclebin' + location.search,
                pk: 'id',
                sortName: 'id',
                columns: [
                    [
