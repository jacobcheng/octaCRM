...
class Client extends Model
{
    ...
    {
        return ['独立网站' => __('独立网站'), '阿里巴巴国际' => __('阿里巴巴国际'), '中国制造' => __('中国制造'), '环球资源展一期' => __('环球资源展一期'), '环球资源展二期' => __('环球资源展二期'), '贸发局电子展' => __('贸发局电子展'), '广交会' => __('广交会'), '领英' => __('领英'), 'Facebook' => __('Facebook')];
    }

    public function getTypeList()
    {
        return ['零售商' => __('零售商'), '批发商' => __('批发商'), '品牌商' => __('品牌商'), '进口商' => __('进口商'), '连锁商超' => __('连锁商超'), '企业' => __('企业')];
    }
